...
'''Adding transcript function for transcript tab'''
@transaction.commit_manually

def hello(request):
    name = "hello"
    t2 = get_template('hello.html')
    html = t2.render(Context({'name' : name}))
...
def todays_transcript(request):
    name = "todays_transcript"
    b1 = get_template('todays_transcript.html')
    html = b1.render(Context({'name' : name}))
    return HttpResponse(html)
...
'''Adding Slides function for Slides tab'''
@transaction.commit_manually
def slide1(request):
    name = "slide"
    k1 = get_template('slide1.html')
    html = k1.render(Context({'name' : name}))
    return HttpResponse(html)
...
'''Adding Interactions function for Interaction tab'''
@transaction.commit_manually
def interact(request):
    name = "interaction"
    u1 = get_template('interact.html')
    html = u1.render(Context({'name' : name}))
    return HttpResponse(html)
...
'''Adding Explain function for Explain tab'''
#@transaction.commit_manually
def explain(request):
    name = "explain"
    r1 = get_template('explain.html')
    html = r1.render(Context({'name' : name}))
    return HttpResponse(html)

def newexplain(request):
    name = "newexplain"
    z1 = get_template('newexplain.html')
    html = z1.render(Context({'name' : name}))
    return HttpResponse(html)
...
'''Adding Questions function for Question tab'''
@transaction.commit_manually
def question(request):
    name = "question"
    y1 = get_template('question.html')
    html = y1.render(Context({'name' : name}))
    return HttpResponse(html)
...
'''Adding Summary function for Summary tab'''
@transaction.commit_manually
def summary(request):
    name = "summary"
    x1 = get_template('summary.html')
    html = x1.render(Context({'name' : name}))
    return HttpResponse(html)
